...
import BackIcon from './css/arrow_down.png'
import ReactSwipe from 'react-swipe'
// import {connect} from 'react-redux'
// import { getDetail } from '../../actions/detailActions'
// import {bindActionCreators} from 'redux'
import gou from './css/gou.png'
import time from './css/time.png'
...
class Detail extends Component {
    ...
    componentDidMount() {
      ...
      //init state
        this.props.getDetail('/api/orderDetail', this.props.match.params)//react-router --- match
        //console.log(this.props.getDetail('/api/orderDetail', this.props.match.params))
